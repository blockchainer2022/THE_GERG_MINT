...
const data = [
  {
    question: "Which Wallet can i connect to mint The gerg",
    answer:
  ...
  },
  {
    ...
    answer:
      "Minting a The Gerg means that you are buying a digital art which becomes a part of the ethereum blockchain. Your digital artwork is represented as an NFT so it can be traded in the market and digitally tracked as it is resold or collected again in the future.",
  },
  {
